...
public class AppService extends Service {
    ...
    private static final String ACTION_REFRESH_OVERLAYS = "com.sorento.navi.REFRESH_OVERLAYS";
    private static final String ACTION_USB_PERMISSION = "com.sorento.navi.USB_PERMISSION";
    ...
    private Notification notification(String text) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && nm != null) {
            NotificationChannel channel = new NotificationChannel(CHANNEL, "Sportage connection", NotificationManager.IMPORTANCE_LOW);
