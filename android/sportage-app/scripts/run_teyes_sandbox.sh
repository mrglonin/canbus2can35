...
LOGICAL_WIDTH="${SPORTAGE_EMULATOR_WIDTH:-1000}"
LOGICAL_HEIGHT="${SPORTAGE_EMULATOR_HEIGHT:-600}"
LCD_DENSITY="${SPORTAGE_EMULATOR_DENSITY:-160}"
SYSTEM_IMAGE="${SPORTAGE_SYSTEM_IMAGE:-system-images;android-35;google_apis;arm64-v8a}"
AVD_NAME="${SPORTAGE_AVD_NAME:-teyes_cc4pro_${LOGICAL_WIDTH}x${LOGICAL_HEIGHT}}"
DRY_RUN=false
